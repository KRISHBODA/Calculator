...
const baseDir = path.resolve(process.cwd(), 'src/pages');

const calculators = [
  // Mortgage & Real Estate
  {
    dir: 'mortgage-real-estate',
  ...
  },
  {
    ...
    category: 'Mortgage & Real Estate',
    categoryHref: '/#mortgage-real-estate',
    resultLabel: 'Maximum Home Purchase Price',
    resultSuffix: 'est.',
  ...
  },
  {
    ...
    category: 'Mortgage & Real Estate',
    categoryHref: '/#mortgage-real-estate',
    resultLabel: 'Capitalization Rate (Cap Rate)',
    resultSuffix: '%',
  ...
  },
  {
    ...
    category: 'Mortgage & Real Estate',
    categoryHref: '/#mortgage-real-estate',
    resultLabel: 'Monthly Refinance Savings',
    resultSuffix: '/mo',
...
console.log('Writing additional calculators...');
`
